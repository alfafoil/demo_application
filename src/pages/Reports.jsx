      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-500 mt-1 text-sm">
              Sales analytics and performance breakdown.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
          {cards.map(({ label, value, sub, Icon, color }) => (
            ...
            >
              <div
                className={`w-11 h-11 rounded-xl bg-gradient-to-br ${color} flex items-center justify-center shadow-md mb-4 group-hover:scale-110 transition-transform duration-300`}
              >
                ...
                <tbody className="divide-y divide-slate-100">
                  {monthly.map((r) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5 text-sm text-slate-700 text-right">
                        {r.sales}
                      </td>
                      <td className="px-4 py-3.5 text-sm text-slate-500 text-right">
                        {r.orders}
                      </td>
                      <td className="px-6 py-3.5 text-right">
                        <span
                          className={`inline-flex items-center gap-1 text-xs font-semibold px-2 py-0.5 rounded-full ${r.up ? "bg-emerald-50 text-emerald-600" : "bg-rose-50 text-rose-600"}`}
                        >
                          {r.up ? (
